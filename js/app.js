...
import { createEverybodysPicksView } from './views/everybodys-picks.js?v=20260823-1';
import { createWeeklyResultsView } from './views/weekly-results.js?v=20260823-1';

const APP_DEPLOYMENT_VERSION = '20260823-1';
