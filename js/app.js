...
import { createManagerPaymentsView } from './views/manager-payments.js?v=20260823-6';
import { createManagerWeekView } from './views/manager-week.js?v=20260823-5';
...
import { createPlayerDashboardView } from './views/player-dashboard.js?v=20260823-9';
...
import { createPlayerPaymentsView } from './views/player-payments.js?v=20260823-9';
...
import { createEverybodysPicksView } from './views/everybodys-picks.js?v=20260823-3';
import { createWeeklyResultsView } from './views/weekly-results.js?v=20260823-4';

const APP_DEPLOYMENT_VERSION = '20260823-9';
