import { APP_CONFIG } from './config.js?v=20260815-1';
import { requestAction } from './api.js?v=20260815-1';
import { registerRoute, startRouter } from './router.js?v=20260815-1';
import { createManagerLoginView } from './views/manager-login.js?v=20260815-1';
import { createManagerDashboardView } from './views/manager-dashboard.js?v=20260815-1';
import { createManagerPlayersView } from './views/manager-players.js?v=20260815-1';
import { createManagerPaymentsView } from './views/manager-payments.js?v=20260815-1';
import { createManagerWeekView } from './views/manager-week.js?v=20260815-1';
import { createManagerMessagesView } from './views/manager-messages.js?v=20260815-1';
import { createManagerReferralsView } from './views/manager-referrals.js?v=20260815-1';
import { createPlayerRegisterView } from './views/player-register.js?v=20260815-1';
import { createPlayerLoginView } from './views/player-login.js?v=20260815-1';
import { createPlayerDashboardView } from './views/player-dashboard.js?v=20260815-1';
import { createPlayerPicksView } from './views/player-picks.js?v=20260815-1';
import { createPlayerMessagesView } from './views/player-messages.js?v=20260815-1';
import { createPlayerPaymentsView } from './views/player-payments.js?v=20260815-1';
import { createPlayerReferralsView } from './views/player-referrals.js?v=20260815-1';
import { createPlayerHelpView } from './views/player-help.js?v=20260815-1';
import { createPlayerEntryPicksView } from './views/player-entry-picks.js?v=20260815-1';
import { createEverybodysPicksView } from './views/everybodys-picks.js?v=20260815-1';
import { createWeeklyResultsView } from './views/weekly-results.js?v=20260815-1';
