...
import { createManagerWeekView } from './views/manager-week.js?v=20260823-14';
...
import { createPlayerEntryPicksView } from './views/player-entry-picks.js?v=20260919-1';
import { createEverybodysPicksView } from './views/everybodys-picks.js?v=20260919-1';
import { createWeeklyResultsView } from './views/weekly-results.js?v=20260919-1';

const APP_DEPLOYMENT_VERSION = '20260919-5';
